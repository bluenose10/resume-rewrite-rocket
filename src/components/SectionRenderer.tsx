              ...
              {data.certifications.map((cert) => (
                <div key={cert.id} className="flex justify-between items-start">
                  ...
                  <div className="text-xs font-medium text-right">
                    ...
                    {cert.expiryDate && (
                      <div className="mt-1" style={{ color: theme.secondary }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {data.references.map((ref) => (
                <div key={ref.id}>
                  ...
                  <p className="text-xs mb-1" style={{ color: theme.text }}>{ref.company}</p>
                  <p className="text-xs mb-1" style={{ color: theme.text }}>{ref.relationship}</p>
                  <p className="text-xs mb-1" style={{ color: theme.text }}>{ref.email}</p>
                  <p className="text-xs" style={{ color: theme.text }}>{ref.phone}</p>
                </div>
              ))}
            </div>
          </ResumeSection>
